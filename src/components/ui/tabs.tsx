...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-center rounded-lg bg-black/20 p-1.5 gap-1",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "bg-gray-700/50 text-gray-300 shadow-md border border-white/10",
      "hover:bg-gray-600/60",
      "data-[state=active]:bg-cyan-800/80 data-[state=active]:text-cyan-100 data-[state=active]:shadow-[inset_0_1px_2px_rgba(0,0,0,0.6)] data-[state=active]:border-cyan-600",
      className
    )}
    {...props}
  />
